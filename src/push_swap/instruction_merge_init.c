...
/*   Updated: 2021/04/30 19:19:31 by clkuznie         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
	...
	*shorter_subsequence = NULL;
	if (subsequence_a && subsequence_b)
	{
		if ((size_t)subsequence_a->content > (size_t)subsequence_b->content
			|| (subsequence_a->content == subsequence_b->content
				&& (size_t)subsequence_a->content > 0
			&& ((size_t)subsequence_a->next->content == SA
				|| (size_t)subsequence_a->next->content == SB)))
		{
