...
/*   Updated: 2021/04/30 19:18:43 by clkuznie         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
	...
	t_list *subsequence_b)
{
	...
	if (!longer_subsequence)
		return (NULL);
	instruction_sequence_merge_loop(longer_subsequence->next,
		&shorter_subsequence);
	instruction_merge_finish(longer_subsequence, shorter_subsequence);
	longer_subsequence->content =
		(void *)(size_t)ft_lstsize(longer_subsequence->next);
