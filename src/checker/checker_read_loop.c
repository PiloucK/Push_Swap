...
/*   Updated: 2021/04/18 17:38:46 by clkuznie         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int
checker_read_loop(int *stack[3], t_instruction_function instruction_array[256])
{
	char				read_buf[4];
	int					read_len;
	...
	{
		print_stack_column(stack, stack[0][0] + stack[1][0]);
