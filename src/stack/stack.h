...
/*   Updated: 2021/04/20 17:35:44 by clkuznie         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	stack_reset(int *stack[3]);

void	util_int_swap(int *a, int *b);
int		util_is_stack_biggest(int *stack[3], int current, int stack_to_scan);
int		util_is_stack_smallest(int *stack[3], int current, int stack_to_scan);
